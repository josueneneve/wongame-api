      ...
      <Container className="container-fluid">
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              <h2 id="mainHeader">Welcome Won Games!</h2>
              <P>
                To tha side you can insert diferents games, categories and
                publishers for our amazing store games!
              </P>
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              <h2>Social Links!</h2>
              <P style={{ marginTop: 7, marginBottom: 0 }}>In case doubt, you can access the social links.</P>
